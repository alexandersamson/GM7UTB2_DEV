#ifndef PromptWelcomeScreen_h
#define PromptWelcomeScreen_h
...
class PromptWelcomeScreen : public Prompt {
  ...
  public:
    PromptWelcomeScreen(Image<RGB565> *tgxImageObj, Sprites *spritesObj, Constants *constantsObj, Globals *globalsObj, Interface *interfaceObj, GuiButtons *guiButtonsObj);
