#ifndef PromptShowHints_h
#define PromptShowHints_h
...
class PromptShowHints : public Prompt {
  ...
  public:
    PromptShowHints(Image<RGB565> *tgxImageObj, Sprites *spritesObj, Constants *constantsObj, Globals *globalsObj, Interface *interfaceObj, GuiButtons *guiButtonsObj);
